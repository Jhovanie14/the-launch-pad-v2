...
export const metadata: Metadata = {
  ...
  description:
    "The Launch Pad in Houston offers 24/7 self-service car wash bays, professional express detailing, and monthly memberships at 10410 Main St. Book online in minutes.",
  keywords: [
    "car wash Houston",
  ...
  openGraph: {
    ...
    description:
      "24/7 self-service car wash bays, professional express detailing, and monthly memberships. Visit us at 10410 Main St, Houston. Book online today!",
  ...
  twitter: {
    ...
    title: "The Launch Pad | Car Wash & Express Detailing in Houston, TX",
    description:
      "24/7 self-service car wash bays, professional express detailing, and monthly memberships at 10410 Main St, Houston.",
