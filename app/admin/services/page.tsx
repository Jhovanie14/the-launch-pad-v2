...
export const metadata: Metadata = {
  ...
  description:
    "Self-service car wash bays $10 per visit, express detailing from $25, and unlimited monthly memberships: Basic $39.99/mo and Deluxe $59.99/mo. One price for all vehicles — no vehicle upcharges.",
  alternates: {
    canonical: "/services",
  },
  openGraph: {
